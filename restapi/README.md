...
**API Reading**
- [1] CRUD REST API Java, Spring, MySQL. Entidade com anotações, Mapeamento, Id e restrições de colunas.  [tutorial](fhttps://www.youtube.com/watch?v=aEAFpQfcu-0) for more
